...
<body>
            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td><?php echo $result['repositorio'] ?></td>
                            <td><?php echo $result['demo'] ?></td>
    ...
    <div class="modalproyecto" id="modalproyecto">
        <div class="proyectos-add-container">
            <form action="../logic/addproyect" method="post"  enctype="multipart/form-data" autocomplete="off">
                <div>
                ...
                <div>
                    <label for="">Repositorio proyecto</label>
                    <input type="text" name="repositori" id="repositori">
                </div>
                <div>
                    <label for="">Demo del proyecto</label>
