...
<body>
    ...
    <div class="modalproyecto" id="modalproyecto">
        <div class="proyectos-add-container">
            <form action="../logic/addtechnologies" method="post"  enctype="multipart/form-data" autocomplete="off">
                <div>
                    <label for="">Nombre de tecnologia</label>
                    <input type="text" name="name" id="name">
                </div>
                <div>
                    <label for="">Imagen de la tecnologia</label>
